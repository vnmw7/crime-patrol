...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-full mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
              <span className="text-blue-700 dark:text-blue-300 font-medium text-sm">JD</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="flex">
        {/* Sidebar */}
        <div className={`${isSidebarOpen ? "block" : "hidden"} w-64 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 min-h-[calc(100vh-64px)] transition-all duration-300`}>
          <div className="p-5">
            <nav className="space-y-1">
              {[
                ...
                { path: "reports", label: "My Reports", icon: "file" },

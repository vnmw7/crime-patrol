    ...
    <div className="min-h-screen w-full bg-gray-900 text-white">
      ...
      <header className="w-full px-10 py-4 bg-gray-800 flex justify-between items-center border-b border-gray-700">
        ...
        <nav className="flex gap-6 items-center">
          ...
          <a href="#download" className="text-white hover:text-blue-400">Download</a>
          <Link to="/login" className="text-white hover:text-blue-400">Log in</Link>
          <Link to="/signup" className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded text-white">
            Sign up
          </Link>
        </nav>
      </header>

...
export default function DashboardChat() {
  const [messages, setMessages] = useState([
    ...
    { id: 2, sender: "User", text: "I need information about recent incidents." },
    { id: 3, sender: "AI", text: "Sure, please specify the area or type of incident." },
  ]);
  ...
  const handleSend = () => {
    if (inputText.trim()) {
      setMessages([
        ...
        { id: Date.now() + 1, sender: "AI", text: "Processing your request..." },
      ]);
      setInputText("");
    }
  };

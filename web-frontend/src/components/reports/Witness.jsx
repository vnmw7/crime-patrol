...
const WITNESSES_COLLECTION_ID = import.meta.env
  .VITE_APPWRITE_REPORT_WITNESSES_COLLECTION_ID;
  ...
  return (
    <div className="p-6">
      ...
      {loading ? (
        ...
        <p className="text-gray-500 text-gray-400">No witness records found.</p>
      ) : (

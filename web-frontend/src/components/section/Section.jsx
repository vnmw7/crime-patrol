...
const SectionPage = () => {
  ...
  const updateStatus = async (id, newStatus) => {
    try {
      ...
      const updatedBy = currentUser?.email || currentUser?.name || "admin";
            ...
            <div className="modal" onClick={(e) => e.stopPropagation()}>
              ...
              {currentPage === 1 && (
                <>
                  ...
                  <p>
                    <strong>Reporter's Phone Number:</strong>{" "}
                    {selectedReport.Reporter_Phone || "Anonymous"}
                  </p>
                  <p>
                    <strong>Witness Info:</strong>{" "}
                    {selectedReport.Witness_Info || "—"}
                  </p>
                </>
              )}
              ...
              {currentPage === 2 && (
                <>
                  <p>
                    ...
                    {selectedReport.Victim_Name || "—"}
                  </p>
                  <p>
                    <strong>Victim's Contact:</strong>{" "}
                    {selectedReport.Victim_Contact || "—"}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Suspect's Description:</strong>{" "}
                    {selectedReport.Suspect_Description || "—"}
                  </p>
                  <p>
                    <strong>Suspect's Vehicle:</strong>{" "}
                    {selectedReport.Suspect_Vehicle || "—"}
                  </p>
                  <p>
                    <strong>Is In Progress:</strong>{" "}
                    {selectedReport.Is_In_Progress ? "Yes" : "No"}
                  </p>
                  <p>
